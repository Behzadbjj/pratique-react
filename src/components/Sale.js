...
const Sale = () => {
    return (
        <div>
                   ...
                   {/* ////////////////////////////SALE///////////////////////////////// */}
    <h1 className="titrePage" id="sale">NOS RECETTES SALEES</h1>
    ...
    <div className="container">
        ...
        <h1 className="titreArticle">Gratin de courgettes façon dauphinois</h1>
    <section className="article1">
        ...
        <h1 className="titreArticle">Cannelloni à la bolognaise</h1>
    <section className="article2">
        ...
        <h1 className="titreArticle">Couscous Royal</h1>
    <section className="article1">
